...
export const Info = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4 text-[#a98467] text-center border-b-2 border-[#6c584c]">Encuentra tu próximo empleo con DevJobs</h1>
      ...
      <p className="text-lg mt-8 mb-4">Bienvenido a DevJobs, el mejor lugar para buscar empleo en la industria tecnológica. Ya sea que estés buscando tu primer trabajo en el sector o que quieras dar el próximo paso en tu carrera, estamos aquí para ayudarte a encontrar las mejores oportunidades laborales.</p>
      <p className="text-lg mb-4">En DevJobs, ofrecemos una amplia variedad de ofertas laborales en áreas como desarrollo web, inteligencia artificial, ciencia de datos, ciberseguridad y mucho más. Nuestro objetivo es conectar a profesionales talentosos con empresas innovadoras que buscan su experiencia y habilidades.</p>
      ...
      <p className="text-lg mb-4">Regístrate ahora en DevJobs y empieza a construir tu futuro profesional hoy mismo. ¡El trabajo de tus sueños te está esperando!</p>
    </div>
  );
};
